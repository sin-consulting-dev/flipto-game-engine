    ...
    <header className="bg-secondary-dark/50 border-b border-border-color fixed top-0 left-0 w-full z-50">
      <div className="container mx-auto flex items-center justify-between p-4">
        ...
        <div className="flex items-center space-x-4">
          ...
          <button className="bg-primary-yellow text-gray-900 font-bold py-2 w-32 rounded-md hover:bg-yellow-400 transition-colors" onClick={() => navigate('/deposit')}>
            Deposit
          </button>
      ...
      {/* Modal removed, now handled by /deposit page */}
    </header>
  );
};
